...
This application/site was created as a submission to a [DevChallenges](https://devchallenges.io/challenges) challenge. was to build an application to complete the given user stories:
